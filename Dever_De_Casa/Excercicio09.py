...
if operacao > operacao2 >operacao3:
    ...
    print("Segundo numero é mediano: {}".format(operacao2))
    print("Terceiro numero é menor: {}".format(operacao3))

if operacao > operacao3 > operacao2:
    print("Primeiro numero é maior: {}".format(operacao))
    print("Terceiro numero é mediano: {}".format(operacao3))
    print("Segundo numero é menor: {}".format(operacao2))

if operacao2 > operacao > operacao3:
    print("Segundo numero é maior: {}".format(operacao2))
    print("Primeiro numero é mediano: {}".format(operacao))
    print("Terceiro numero é menor: {}".format(operacao3))

if operacao2 > operacao3 > operacao:
    print("Segundo numero é maior: {}".format(operacao2))
    print("Terceiro numero é mediano: {}".format(operacao3))
    print("Primeiro numero é menor: {}".format(operacao))
